...
<body>
    ...
    <main>
        <form action="index.php" method="post">
            ...
            <h1>ÍNDICE DE CALIDAD DE SUEÑO DE PITTSBURGH (PSQI)</h1>
            <div class="header-form">
                <diiv class="datos-part">
                    <fieldset>
                        <legend>Datos del participante</legend>
                        <label for="cod_participante">Código del participante: </label>
                        <input type="text" name="cod_participante"
                            value="<?php echo $_SESSION['cod_participante'] ?? ''; ?>" disabled><br><br>
                ...
                <div class="instrucciones">
                    <p><strong>Instrucciones:</strong> Las siguientes cuestiones solo tienen que ver con sus hábitos de
                        sueño durante el último mes. En sus respuestas debe reflejar cual ha sido su comportamiento
            ...
            <fieldset>
                ...
                <label for="hora_acostarse">
                    <p>1. Durante el último mes, ¿cuál ha sido, normalmente, su hora de
                        acostarse?</p>
                </label>
                <input type="text" id="hora_acostarse" name="Sue1" placeholder="ej. 23:30">

                <label>
                    <p>2. ¿Cuánto tiempo habrá tardado en dormirse, normalmente, las noches del último mes?</p>
                </label>
                ...
                <label for="tardar_mas_60">Más de 60 min</label>

                <label for="hora_levantarse">
                    <p>3. Durante el último mes, ¿a qué hora se ha levantado habitualmente por la
                        mañana?</p>
                </label>
                <input type="text" id="hora_levantarse" name="Sue3" placeholder="ej. 07:30">

                <label for="horas_Sueno">
                    <p>4. ¿Cuántas horas calcula que habrá dormido verdaderamente cada noche durante
                        el último mes?</p>
                </label>
                <input type="text" id="horas_Sueno" name="Sue4" placeholder="ej. 7.5 horas">
            </fieldset>

            <fieldset>
                <legend>5. Durante el último mes, ¿cuántas veces ha tenido usted problemas para dormir a causa de?
                </legend>
            ...
            <fieldset>
                ...
                <label>Durante el último mes, ¿cuántas veces habrá tomado medicinas (por su cuenta o recetadas por el
                    médico) para dormir?</label><br>
            ...
            <fieldset>
                ...
                <label>Durante el último mes, ¿cuántas veces ha sentido somnolencia mientras conducía, comía o
                    desarrollaba alguna otra actividad?</label><br>
            ...
            <fieldset>
                ...
                <label>Durante el último mes, ¿ha representado para usted mucho problema el tener ánimos para realizar
                    alguna de las actividades detalladas en la pregunta anterior?</label><br>
